...
export default function ExperienceSection() {
  ...
  return (
    <div className="w-full mx-auto timeline-component">
      ...
      `}</style>
      <h1 className="relative inline-block md:mx-20 px-1 py-1.5 mb-16 text-7xl lg:text-8xl font-bold transition-colors duration-300 ease-in-out group h-fit w-fit">
